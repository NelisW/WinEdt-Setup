...
\centerline{\includegraphics[bb= 0 0 295 388, scale=0.7]{eps/loadini.png}}
...
\centerline{\includegraphics[bb= 0 0 696 543, scale=0.7]{eps/StartViewer.png}}
...
\centerline{\includegraphics[bb= 0 0 344 416, scale=0.7]{eps/yapinverse.png}}
...
\centerline{\includegraphics[bb= 0 0 1047 346, scale=0.5]{eps/ASbegin.png}}
...
\centerline{\includegraphics[bb= 0 0 1047 386, scale=0.5]{eps/dictionary.png}}
...
\centerline{\includegraphics[bb= 0 0 1037 179,scale=0.5]{eps/texsymbolsgiu.png}}
...
\centerline{\includegraphics[bb= 0 0 1037 288,scale=0.5]{eps/trimeoleof.png}}
...
\centerline{\includegraphics[bb= 0 0 1093 397,scale=0.5]{eps/wrapping.png}}
...
\centerline{\includegraphics[bb= 0 0 1055 431,scale=0.5]{eps/AddExcelTable.png}}
...
Add the file with the following contents to
\lstinline{C:/Program Files/WinEdt Team/WinEdt 10/Macros/Samples/bstofs.edt} (or wherever you want to save it)
...
\centerline{\includegraphics[bb= 0 0 696 543,scale=0.5]{eps/synctex.png}}
...
\centerline{\includegraphics[bb= 0 0 437 457,scale=0.4]{pic/savingback.png}}
...
\centerline{\includegraphics[bb= 0 0 999 88, scale=0.5]{pic/Typeface.png}}

Add the new buttons to the current image, taking care that you keep the new buttons the same size.

$<$Options$>$$<$Options Interface$>$$<$Additional GUI Controls...$>$$<$TeX Symbols$>$, edit the macro file just opened. Locate this section corresponding to the Typeface part of the GUI:
...
Create the appropriate scripts, with the contents below, and save these in \url{C:\Program Files\WinEdt Team\WinEdt 9\Macros\Fonts\}:
...
Activate
$<$Options$>$$<$Execution Modes$>$ and select the dvi2ps entry in the 'Accessories' list box. Then enter the switch \verb"-I 2cr8" in the 'Switches' textbox, as shown in the following figure.  The bmeps FAQ is located at \verb"http://bmeps.sourceforge.net/faq.html"

\centerline{\includegraphics[bb= 0 0 696 543,scale=0.7]{eps/dvipsbmeps.png}}
...
{\small
\verb"\centerline{\includegraphics[bb= 0 0 288 200,scale=1]{pic/light_trap2.jpg}}"
}


\centerline{\includegraphics[bb= 0 0  288 200,scale=1]{pic/light_trap2.jpg}}
...
\centerline{\includegraphics[bb= 0 0 696 543,scale=0.7]{eps/ps2pdfpagesize.png}}

%Open the file \verb"C:\Program Files\WinEdt Team\WinEdt 9\Exec\TeX\ps2pdf.edt"
...
\centerline{\includegraphics[bb= 0 0 1055 352,scale=0.5]{eps/updatedrives.png}}
