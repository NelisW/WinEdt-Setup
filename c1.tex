...
In the following changed file the items to remove mw files is added and the sync file is set to be ticked by default:
...
//      EraseWorkingFiles("Folder List;", "Caption", Subfolders: -1..1, Invisible: 0..1);
    ...
    AddFileItem(1,"SYNC File","%N.synctex.*","TeX");
